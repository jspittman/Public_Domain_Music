...
var podcastURLclassical = "https://www.gomain.com/public-domain/classical.m3u";
var podcastURLjazz = "https://www.gomain.com/public-domain/jazz.m3u";
var podcastURLmodernjazz = "https://www.gomain.com/public-domain/modernjazz.m3u";
var podcastURLopera = "https://www.gomain.com/public-domain/opera.m3u";
...
SidRothPlayer.prototype.handle = function () {
   ...
   if (requestType === "LaunchRequest") {
        ...
        if (intent.name === "Play") {
            this.play(podcastURL, 0);
        } else if (intent.name === "ClassicalIntent") {
            this.play(podcastURLclassical, 0);
        } else if (intent.name === "JazzIntent") {
            this.play(podcastURLjazz, 0);
        } else if (intent.name === "ModernJazzIntent") {
            this.play(podcastURLmodernjazz, 0);
        } else if (intent.name === "OperaIntent") {
            this.play(podcastURLopera, 0);
